...
# widely inspired from https://github.com/kubernetes/enhancements/blob/master/hack/verify-toc.sh but use the curl instead
# of go to get binary. Thansk to the kubernetes authors

# This scirpt verify toc of all md file in the repo are up to date
