 ...
 *
 * note: this enum lust be keep in sync with [org.opa.ideaplugin.ide.highlight.RegoHighlighter]. If you define
 * a color that in not defined in the highlighter, then user will be able to customize it but ide will never render it.
 *
 * @see org.opa.ideaplugin.ide.colors.RegoColorSettingsPage
 * @see org.opa.ideaplugin.ide.highlight.RegoHighlighter
 */
enum class RegoColor(humanName: String, val default: TextAttributesKey? = null) {
    ...
    val textAttributesKey = TextAttributesKey.createTextAttributesKey("org.opa.ideaplugin.$name", default)
