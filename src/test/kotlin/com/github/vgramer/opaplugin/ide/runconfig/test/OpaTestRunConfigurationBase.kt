...
import com.github.vgramer.opaplugin.ide.runconfig.RunConfigurationTestBase
...
abstract class OpaTestRunConfigurationBase : RunConfigurationTestBase() {
    ...
    /**
     * check the error message (correspond to the key "message" in [com.github.vgramer.opaplugin.ide.runconfig.test.OpaTestEventsConverter.fireFailedTest])
     ...
     *
     * see [com.github.vgramer.opaplugin.ide.runconfig.test.TestRunConfigurationExecutionOpaTest] for example
     *
     */
