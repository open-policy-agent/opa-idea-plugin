...
import org.opa.ideaplugin.ide.runconfig.RunConfigurationTestBase
...
abstract class OpaTestRunConfigurationBase : RunConfigurationTestBase() {
    ...
    /**
     * check the error message (correspond to the key "message" in [org.opa.ideaplugin.ide.runconfig.test.OpaTestEventsConverter.fireFailedTest])
     ...
     *
     * see [org.opa.ideaplugin.ide.runconfig.test.TestRunConfigurationExecutionOpaTest] for example
     *
     */
