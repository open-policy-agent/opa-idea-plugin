...
import org.opa.ideaplugin.OpaWithRealProjectTestBase
...
abstract class RunConfigurationTestBase : OpaWithRealProjectTestBase() {
     ...
     * use [executeAndGetOutput] or [org.opa.ideaplugin.ide.runconfig.test.OpaTestRunConfigurationBase.executeAndGetTestRoot]
     * instead
     */
